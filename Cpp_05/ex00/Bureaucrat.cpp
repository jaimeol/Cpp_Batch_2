...
/*   Updated: 2025/02/28 11:39:22 by jolivare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << " Default constructor called for " << this->_name << " with a grade of " << this->_grade << std::endl;
}
...
{
	std::cout << " Default deconstructor called for " << this->getName() << std::endl;
}
